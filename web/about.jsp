					...
					<div class="page">
						...
						<div class="row">
							...
							<div class="col-md-8">
								...
								<p>We are a team of 6 NIT DGPians, spamming the movie ideas in everyone's mind. Our team consist of extremely enthusiastic people ready to take on the world in this jonour.</p>
								<p>A film, also called a movie, motion picture, theatrical film or photoplay, is a series of still images which, when shown on a screen, creates the illusion of moving images due to the phi phenomenon. This optical illusion causes the audience to perceive continuous motion between separate objects viewed rapidly in succession. The process of filmmaking is both an art and an industry. A film is created by photographing actual scenes with a motion picture camera; by photographing drawings or miniature models using traditional animation techniques; by means of CGI and computer animation; or by a combination of some or all of these techniques and other visual effects. The word "cinema", short for cinematography, is often used to refer to the industry of films and filmmaking or to the art of filmmaking itself. The contemporary definition of cinema is the art of simulating experiences to communicate ideas, stories, perceptions, feelings, beauty or atmosphere by the means of recorded or programmed moving images along with other sensory stimulations.</p>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-9">
								...
								<p>Search movies online. Put them in our site and make it available for you to rate and share among your friends. We hope this makes your life easier since this makes our project easy.</p>

								<p>And one more thing, we are also making the world flat by making this platform freely available to everyone, hence giving everyone the equal opportunity to contribute</p>
							</div>
							<!-- <div class="col-md-3">
						...
						<h2 class="section-title">Our Team - PASSTA</h2>
						<div class="row">
