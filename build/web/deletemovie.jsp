...
<%
    ...
    String movie_name = request.getParameter("name2");
...
%>
                    <div class="main-content">
                        <div>
                            <h1 align  = "center">Congratulations, <%=movie_name%> has been deleted successfully from our database. Thank you!</h1>
                        </div>
...
<div class="main-content">
	...
	<div class="page">
                        <div>
                            <h1 align  = "center">Sorry! <%=movie_name%> has not been deleted. Please resolve the error!</h1>                           
                        </div>
        </div>
    </div>
